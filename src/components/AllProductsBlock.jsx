...
function AllProductsBlock(props) {
  ...
  return (
   ...
   <SoloProductsBlock2 data={set1} dName={one}/>
   <SoloProductsBlock2 data={set2} dName={two}/>
   <SoloProductsBlock2 data={set3} dName={three}/>
   <SoloProductsBlock2 data={set4} dName={four}/>
